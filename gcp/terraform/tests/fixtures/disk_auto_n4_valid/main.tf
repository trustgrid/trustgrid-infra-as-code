## Fixture: disk_type_mode = "auto", n4 machine family (positive)
## Acceptance criterion: auto mode with an n4 machine type must pass validate.
##   The effective_disk_type local will resolve to "hyperdisk-balanced" at plan time.
...
module "trustgrid_node" {
  ...
  ## disk_type_mode defaults to "auto" — hyperdisk-balanced selected automatically for n4.

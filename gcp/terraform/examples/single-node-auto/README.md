...
| Example | When to use |
|---|---|
| [`single-node-manual`](../single-node-manual) | Single edge node, manual registration |
| **This example** (`single-node-auto`) | Single edge node, automatic registration via license key |
